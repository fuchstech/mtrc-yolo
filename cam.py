...
while True:
    ...
    labels = ["person","bicycle","car","motorcycle","airplane","bus","train","truck","boat",
              "trafficlight","firehydrant","stopsign","parkingmeter","bench","bird","cat",
                "dog","horse","sheep","OKUZCUK","elephant","bear","zebra","giraffe","backpack",
...
#%%
    ...
    model = cv2.dnn.readNetFromDarknet("/home/fuchs/Desktop/Darknet/darknet/yolov4.cfg", "/home/fuchs/Desktop/Darknet/darknet/yolov4.weights")
